...
class source
{
	...
	public function add_article($title,$class,$content)
	{
	...
	{
		$result=mysql_query("select * from lab_article where class='".$class."' order by aid desc limit 0,5;");
		echo "<ul>";
		for($i=0;$i<mysql_num_rows($result);$i++)
		{
			echo "<li>";
			$str=mysql_fetch_array($result);
			echo "<a href='show.php?pid=".$class."&aid=".$str["aid"]."'>";
				echo $str["title"];
			echo "</a>";
			echo"</li>";
		}
